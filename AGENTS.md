...
| Files | kebab-case | `lib-button.component.ts` |
...
import { ParticleButton } from './lib/atoms/lib-button.component';
import type { ButtonVariant } from './button.types';
```
...
<particle-button [disabled]="isDisabled" (click)="onClick()">
  Click me
</particle-button>
```
